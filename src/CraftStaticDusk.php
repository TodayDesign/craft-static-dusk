 ...
 * @since     1.0.1
 *
 * @property  CraftStaticDuskServiceService $craftStaticDuskService
 * @property  Settings $settings
 * @method    Settings getSettings()
 */
class CraftStaticDusk extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'craft-static-dusk/default';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'craft-static-dusk/default/do-something';
            }
        );

        // Register our CP Build routes
        Event::on(
            UrlManager::class,
            UrlManager::EVENT_REGISTER_CP_URL_RULES,
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger2'] = 'craft-static-dusk/generate/build';
            }
        );
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('craftStaticDusk', CraftStaticDuskVariable::class);
            }
        );
