...
/**
 * CraftStaticDuskAsset AssetBundle
 *
 ...
 * @since     1.0.1
 */
class CraftStaticDuskAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@todaydesign/craftstaticdusk/assetbundles/craftstaticdusk/dist";
        ...
        $this->js = [
            'js/CraftStaticDusk.js',
        ];

        $this->css = [
            'css/CraftStaticDusk.css',
        ];
