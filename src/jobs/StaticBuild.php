 ...
 *
 * use todaydesign\craftstaticdusk\jobs\StaticBuild as StaticBuildJob;
 *
 * $queue = Craft::$app->getQueue();
 * $jobId = $queue->push(new StaticBuildJob([
 ...
 * @since     1.0.1
 */
class StaticBuild extends BaseJob
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('craft-static-dusk', 'StaticBuild');
    }
}
